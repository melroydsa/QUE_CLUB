...
function Membership() {
  return (
    ...
    <img id="imgBG" src={BGimg} alt="Background" />
       <Hero MainTextOut="Membership" MainTextSize="7em" MainTextSizeM="5em" MainTextMarginTop="0.4em" MainTextMarginTopM="-430px" SubTextMarginTop="3.6em" SubTextMarginTopM="-11.5em" MainTextOth="Plans" SubText="Choose a plan that works best for you" />
